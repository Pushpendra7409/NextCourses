      ...
      <div className="flex items-center justify-center h-full relative z-10">
        ...
        <h1 className="text-white text-3xl flex items-center justify-center mb-3"><IoMdLogIn /></h1>
          ...
          <form>
            ...
            <button type="submit" className="w-full bg-transparent border-[1px] border-zinc-500 rounded-full text-white py-2 hover:bg-blue-600 transition duration-200 mb-4">Login</button>
